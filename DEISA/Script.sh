...
srun -N $WORKERNODES -n $NWORKER -c $THREADS --relative 1 dask-worker --interface ib0 --local-directory $TMPDIR --scheduler-file=$SCHEFILE 1>>logs/worker.log 2>>logs/worker.log &
